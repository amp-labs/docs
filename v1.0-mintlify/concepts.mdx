...
You create an integration by defining it in a manifest file and then deploying it using the `amp` CLI. (See [Define Integrations](/define-integrations) and [CLI Overview](cli/overview-and-installation)).
...
- or when you make an API call to the [CreateInstallation](reference/installation/create-a-new-installation) or [ImportInstallation](installation/import-an-existing-installation) endpoints.
...
For other terminology, refer to the [Glossary](glossary).
