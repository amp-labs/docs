...
description: We offer a React library with embeddable UI components for integration set up and management.
---
...
* **groupRef** (string): the ID that your app uses to identify a company, team, or workspace. See [group](/glossary#group).
...
We provide a hook `useIsIntegrationInstalled` to check if an integration has been installed yet for this [group](/glossary#group). It takes in 2 parameters:
