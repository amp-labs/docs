...
* `x-amp-installation-id`: the installation ID, you'll get this from the [CreateInstallation](/api-reference/installation/create-a-new-installation) or [ImportInstallation](/api-reference/installation/import-an-existing-installation) API endpoints, or the InstallIntegration React component.
* or both of the following:  
   * `x-amp-integration-name`: the integration name that you wrote in the `amp.yaml` file  
   * `x-amp-group-ref`: the ID for the user group that you used in the [OAuthConnect](/api-reference/oauth/get-url-for-oauth-flow) or [ImportInstallation](/api-reference/installation/import-an-existing-installation) API endpoints; or the InstallIntegration React component.
