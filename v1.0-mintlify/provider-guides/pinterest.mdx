...
> - [Connecting Pinterest to Ampersand](#connecting-pinterest-to-ampersand)
...
4. Enter the app details and click **Submit**.
   ...
   ![Pinterest App Creation](https://files.readme.io/1cd5402-pinterest1.gif)
...
4. Select **Add** to save your changes.
   ...
   ![Pinterest Redirect Configuration](https://files.readme.io/0f94f77-pinterest2.gif)
...
6. Enter the scopes set for your application in _Pinterest_. For more details on the scopes, go to the [Pinterest API Scopes](https://developers.pinterest.com/docs/getting-started/authentication-and-scopes/) documentation.
   ...
   ![Pinterest Integration in Ampersand](https://files.readme.io/5acff64-pinterest3.gif)
