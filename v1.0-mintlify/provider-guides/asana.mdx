...
4. Enter **App Name** and select the relevant app requirements.
   ...
   ![Asana App Creation](https://files.readme.io/f0942e9-asana1.gif)
...
![Asana Redirect Configuration](https://files.readme.io/9d9c63f-Asana2.gif)
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   ![Asana Integration in Ampersand](https://files.readme.io/a88523c-asana.gif)
