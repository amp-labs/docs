...
> - [Creating a HubSpot App](#creating-a-hubspot-app) 
> - [Add HubSpot App Details in Ampersand](#connecting-hubspot-to-ampersand)
...
2. Click **Create an app**.
   ...
   ![HubSpot App Creation](https://files.readme.io/a8c2c6f-hubspot1.gif)

3. In the **Basic Info** section:
   1. Enter **Public app name**.
   2. Add **Description**, **Logo**, and **Support contact** info for your app.

   ![HubSpot App Details](https://files.readme.io/a8c2c6f-hubspot1.gif)
...
3. In the **Redirect URLs** section, add the Ampersand Callback URL: `https://api.withampersand.com/callbacks/v1/oauth`.
   ...
   ![HubSpot Auth Settings](https://files.readme.io/013943e-hubspot3.gif)

4. In the **Scopes** section, select the scopes you'd like to use in your application. You will need to add the same scopes in Ampersand to set up your app.

   ![HubSpot Scopes Selection](https://files.readme.io/1b56fb4-hubspot5.gif)
...
6. Enter the scopes set for your application in HubSpot.
   ...
   ![HubSpot in Ampersand](https://files.readme.io/f4ada70-hubspot6.gif)
