...
> - [Creating a DocuSign App](#creating-a-docusign-app)
> - [Connecting Your Docusign Developer App to Ampersand](https://docs.withampersand.com/docs/docusign#connecting-your-docusign-developer-app-to-ampersand)
> - [Connecting Your Docusign Production App to Ampersand](https://docs.withampersand.com/docs/docusign#connecting-your-docusign-production-app-to-ampersand)
...
8. In the **Additional Settings** section, click  **Add URI** and enter the Ampersand Redirect URI: `https://api.withampersand.com/callbacks/v1/oauth`.
   ...
   ![DocuSign App Creation](https://files.readme.io/57db16b-docusign.gif)
...
5. Enter the previously obtained _Integration Key_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   ![DocuSign Developer Integration](https://files.readme.io/833ae43-docudev1.gif)
...
Once your application is promoted to a production environment, follow the steps below to connect your Docusign Production App to Ampersand:
...
5. Enter the previously obtained _Integration Key_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   ![DocuSign Production Integration](https://files.readme.io/e9b3ac4-docu.gif)
