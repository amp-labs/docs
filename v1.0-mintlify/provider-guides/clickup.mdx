...
- Go to the [ClickUp Sign Up page](https://app.clickup.com/signup).
...
5. Click **Create App**.
   ...
   ![ClickUp App Creation](https://files.readme.io/62de7c7-clickup1.gif)
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   ![ClickUp Integration in Ampersand](https://files.readme.io/d1a4278-clickup2.gif)
