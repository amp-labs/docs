---
title: "Use Ampersand docs with a coding agent or IDE"
description: "Connect Claude Code, Cursor, or another AI coding agent to Ampersand's docs MCP server at docs.withampersand.com/mcp to build integrations faster."
---
