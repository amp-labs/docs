---
title: "Object and field mappings"
---

Ampersand supports object and field mappings. This allows you to either pre-define a set of mappings, or prompt your users to define their own mappings via Ampersand's UI components.
