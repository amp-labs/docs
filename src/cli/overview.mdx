---
title: "Ampersand CLI overview and installation"
description: "Install and use the amp CLI to deploy integrations, manage projects, and interact with the Ampersand platform from your terminal on macOS, Linux, or Windows."
---
