...
<Accordion title="read.backfill.error">
**Webhook destination payload:**
```json
{
  "notificationType": "read.backfill.error",
  "data": {
    "projectId": "8f4a2b1c-3d5e-4f6a-9b0c-1d2e3f4a5b6c",
    "provider": "salesforce",
    "integrationId": "7c9e6679-7425-40de-944b-e07fc1f90ae7",
...
Note: `error` describes what went wrong during the backfill. A later retry of the backfill can still succeed, in which case a `read.backfill.done` notification follows.
</Accordion>
...
**On failure**, `success` is `false` and the error fields are present. For a partial failure,
`successfulRecordIds` is populated too — the records that did land:

```json
{
  "objectName": "Account",
  "success": false,
  "successfulRecordIds": ["provider-record-id-1"],
  "error": "field validation failed; duplicate record"
}
```

`error` is a single string holding every failure message; when several records fail, their messages
are joined with `; `. It is omitted entirely when the write succeeds.
</Accordion>
...
```json
{
  "notificationType": "subscribe.create.success",
  "data": {
    "projectId": "8f4a2b1c-3d5e-4f6a-9b0c-1d2e3f4a5b6c",
    "provider": "salesforce",
    "integrationId": "7c9e6679-7425-40de-944b-e07fc1f90ae7",
...
<Accordion title="subscribe.update.success">
**Webhook destination payload:**
```json
{
  "notificationType": "subscribe.update.success",
  "data": {
    "projectId": "8f4a2b1c-3d5e-4f6a-9b0c-1d2e3f4a5b6c",
    "provider": "salesforce",
    "integrationId": "7c9e6679-7425-40de-944b-e07fc1f90ae7",
...
<Accordion title="subscribe.delete.success">
**Webhook destination payload:**
```json
{
  "notificationType": "subscribe.delete.success",
  "data": {
    "projectId": "8f4a2b1c-3d5e-4f6a-9b0c-1d2e3f4a5b6c",
    "provider": "salesforce",
    "integrationId": "7c9e6679-7425-40de-944b-e07fc1f90ae7",
...
<Accordion title="subscribe.update.error">
**Webhook destination payload:**
```json
{
  "notificationType": "subscribe.update.error",
  "data": {
    "projectId": "8f4a2b1c-3d5e-4f6a-9b0c-1d2e3f4a5b6c",
    "provider": "salesforce",
    "integrationId": "7c9e6679-7425-40de-944b-e07fc1f90ae7",
...
<Accordion title="subscribe.delete.error">
**Webhook destination payload:**
```json
{
  "notificationType": "subscribe.delete.error",
  "data": {
    "projectId": "8f4a2b1c-3d5e-4f6a-9b0c-1d2e3f4a5b6c",
    "provider": "salesforce",
    "integrationId": "7c9e6679-7425-40de-944b-e07fc1f90ae7",
    ...
    "consumerRef": "user-123",
    "consumerName": "John Doe",
    "error": "provider unsubscribe failed after retries; the provider subscription may still be active"
  }
}
```
...
<Accordion title="destination.delivery.error">
**Webhook destination payload:**
```json
{
  "notificationType": "destination.delivery.error",
  "data": {
    "projectId": "8f4a2b1c-3d5e-4f6a-9b0c-1d2e3f4a5b6c",
    "provider": "salesforce",
    "integrationId": "7c9e6679-7425-40de-944b-e07fc1f90ae7",
    ...
    "consumerName": "John Doe",
    "destinationId": "2e8f4c1a-9b3d-4e7f-8a2c-0d1e2f3a4b5c",
    "destinationName": "production-kinesis",
    "objectName": "account",
    "action": "subscribe",
    "error": "Delivery to aws_kinesis destination exhausted retries after 3 attempts. ResourceNotFoundException: Stream not found."
  }
}
```
