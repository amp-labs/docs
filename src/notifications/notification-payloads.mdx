---
title: "Ampersand notification payload reference"
description: "Payload structure for Ampersand notifications delivered to webhook, Amazon S3, and Kinesis destinations, with examples for each installation lifecycle event."
---
