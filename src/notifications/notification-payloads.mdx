...
description: "Payload structure for Ampersand notifications delivered to webhook, Kinesis, and Amazon S3 destinations, including notificationType, data, and config fields."
---
