---
title: "Development and production environments in Ampersand"
description: "Split integration work between dev and prod projects using the amp CLI so you can safely test changes before deploying an integration to your customers."
---
