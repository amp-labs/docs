---
title: "Ampersand prebuilt React UI components"
description: "Embed prebuilt Ampersand React components in your app so customers can connect their SaaS accounts and configure integrations without extra frontend code."
---
