...
The user picks which objects to sync from the provider. A "Write Enabled" toggle appears when the object is selected and supported via the deployed `amp.yaml`.
