...
<div style={{display: 'flex', gap: '1rem', alignItems: 'flex-start'}}>
  <img src="/images/connect-provider-v2.13.7.png" alt="ConnectProvider initial screen" style={{flex: 1, maxWidth: '50%'}} />
  <img src="/images/install-integration-v2.13.7.png" alt="InstallIntegration configuration screen" style={{flex: 1, maxWidth: '50%'}} />
</div>
...
<div style={{display: 'flex', gap: '1rem', alignItems: 'flex-start'}}>
  <img src="/images/connect-provider-v2.13.7.png" alt="ConnectProvider initial state" style={{flex: 1, maxWidth: '50%'}} />
  <img src="/images/connect-provider-success-v2.13.7.png" alt="ConnectProvider connected state" style={{flex: 1, maxWidth: '50%'}} />
</div>
