---
title: "Search actions: query records in customer SaaS"
description: "Define search actions to synchronously query records in your customer's SaaS by filter criteria and return a single page of matching results via the API."
---
