---
title: "Ampersand documentation overview"
description: "Ampersand is a declarative platform for SaaS builders to read, write, and subscribe to data in customer SaaS instances across 150+ providers."
---
