...
<section className="amp-section amp-hero">
  <div>
    ...
    <div className="amp-actions">
      <a className="amp-btn amp-btn--secondary" href="/starter-project">Get started</a>
...
Two steps to your first integration.
...
<CardGroup cols={2}>
  ...
  <Card title="2. Build your first integration" icon="rocket" href="/starter-project">
    Clone a React app with HubSpot already wired up, then swap in your own manifest and deploy.
  </Card>
</CardGroup>
...
- [Never clobber customer data](/write-actions#prevent-overwriting-of-customer-data): control per field whether Ampersand writes on create, on update, or only when the field is empty.
