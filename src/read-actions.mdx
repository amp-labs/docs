---
title: "Read actions"
description: "Define read actions in amp.yaml to schedule or trigger reads of standard and custom objects from a customer's SaaS, with backfill, filters, and mapping."
---
