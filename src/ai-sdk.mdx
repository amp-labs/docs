...
description: "Use the Ampersand AI SDK to let AI agents read, write, and search across connected SaaS tools through the Ampersand platform from any Node.js app."
---
