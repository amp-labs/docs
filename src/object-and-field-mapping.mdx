...
<Note>
When you call the [Get Object Metadata](/reference/objects-&-fields/get-object-metadata-for-connection) API, some providers may return nested fields. These field names can be used directly in your `amp.yaml` configuration.
</Note>
