---
title: "Object and field mapping in Ampersand"
description: "Predefine or let customers pick object and field mappings in Ampersand so you can normalize provider data or expose a mapping UI without extra frontend code."
---
