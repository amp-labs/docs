...
description: "Map provider objects and fields to unified labels in Ampersand, or let customers define their own mappings through the prebuilt UI components."
---
...
If you wish to write data to `company`, you can [inherit the mapping](/write-actions#share-mappings-with-read-actions) from the read action.
