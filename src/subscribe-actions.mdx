...
For the example for a webhook message delivered according to above `amp.yaml`. Please see [Subscribe action webhooks](/destinations/webhooks#subscribe-action-webhooks) section.
