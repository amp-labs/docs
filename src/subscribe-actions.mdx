...
**Note** It usually takes 1–2 minutes, and sometimes up to 10 minutes depending on the provider’s system, to establish the subscription after deploying `amp.yaml`.
