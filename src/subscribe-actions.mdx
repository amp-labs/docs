...
<Note>
  Please note that:
  - Subscribe actions are currently only supported for some providers such as Salesforce, HubSpot, Salesloft and Zoho. Please check the [provider guides](/provider-guides/overview) to see which providers support Subscribe Actions. 
...
**Providers with Special Instructions:**
- [Hubspot](/subscribe-actions#special-set-up-for-hubspot)

## How to Subscribe to Providers

To subscribe to an object from a provider, you currently need to also have a read action specified for the object. In addition, you need to specify:
...
If you do not already have an integration from a provider, follow the instructions in the provider guides to get started.

**Providers Guides:**
- [Salesforce](/provider-guides/salesforce)
- [HubSpot](/provider-guides/hubspot)
- [Zoho](/provider-guides/zoho)
- [Outreach](/provider-guides/outreach)
...
- Define the subscribe action in your `amp.yaml` file, please refer to the previous section.
