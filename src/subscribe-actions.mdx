...
description: "Receive near-instant webhooks from customer SaaS apps with Ampersand subscribe actions on create, update, delete, and association change events."
---
