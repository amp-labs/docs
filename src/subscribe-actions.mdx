      ...
      objects:
        - objectName: account
          ...
          updateEvent:
            enabled: always
            requiredWatchFields:
              - name # this will be mapped according to read action mapping
              - phone
...
Here is an example of a webhook message delivered according to above `amp.yaml`.
...
```json
{
    ...
    "installationId": "561b9048-a3ea-4549-8912-7793a6d61aea",
    "installationUpdateTime": "2025-04-07T23:49:58.528889Z",
    "objectName": "company", // mapped from `account` to `company`
    ...
    "result": [
        {
            ...
            "mappedFields": {
                "accountName": "johnAmp", // mapped from `name` to `accountName`
                "notes": "test" // mapped from `description` to `notes` by user selection
            },
            ...
            "rawEvent": {
                "ChangeEventHeader": {
                    ...
                    "commitNumber": 12039390550076,
                    "commitTimestamp": 1744140365000,
                    "commitUser": "005Dp000003Cd1SIAS",
                    "entityName": "Account",
                    "recordId": "001Dp00000ZDgmxIAD",
                    "sequenceNumber": 1,
                    "transactionKey": "00050801-ab6f-6ce6-c55b-6b2dc8f258e1"
                },
                "LastModifiedDate": "2025-04-08T19:26:05.000Z",
                "Phone": "6502191231"
            },
    ...
    "workspace": "ampersand-dev-ed.develop"
}
```
