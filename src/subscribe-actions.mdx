---
title: "Subscribe actions: real-time SaaS webhooks"
description: "Use Ampersand subscribe actions to receive near-instant webhooks when records are created, updated, or deleted in your customers' SaaS instances."
---
