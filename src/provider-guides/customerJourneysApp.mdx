...
description: "Connect the Customer.io Journeys App to Ampersand with API key auth to power read, write, and proxy actions across your messaging and customer data."
---
## What's supported
