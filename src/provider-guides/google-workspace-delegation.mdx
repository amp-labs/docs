...
excerpt: ""
hidden: false
description: "Configure Google Workspace domain-wide delegation with Ampersand so your app can perform read, write, subscribe, and proxy actions on behalf of user accounts."
---
