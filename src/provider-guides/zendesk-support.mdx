...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d13687c-zendesk11.gif",
        null,
        "Zendesk App Scopes"
      ],
      "align": "center"
...
2. Select the project where you want to add the Zendesk App.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/2faaa99-Ampersand.png",null,"Ampersand Project Selection"],"align":"center"}]}[/block]
...
5. Enter the previously obtained **Client ID / Unique identifier** in the **Client ID** field and the **Client Secret** in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/3859271-zendesk12.gif",null,"Ampersand Project Selection"],"align":"center"}]}[/block]
