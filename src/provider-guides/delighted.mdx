---
title: Delighted
description: "Connect Delighted to Ampersand using Basic Auth credentials and use proxy actions to send survey, response, and NPS data through the Delighted API."
---
