...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c2b6e32-Screenshot_2024-07-30_at_22.53.45.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ca06fa-miro1.gif",
        null,
        "Miro Created App"
      ],
      "align": "center"
...
5. Enter the previously obtained **Client ID** in the **Client ID** field and **Client Secret** in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/8105f9e-miro2.gif",null,"Adding Miro Credentials"],"align":"center"}]}[/block]
