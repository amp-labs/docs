---
title: "Asana"
description: "Register an Asana OAuth app, share the credentials with Ampersand, and enable read, write, and proxy actions across tasks, projects, and workspace objects."
---
## What's Supported
...
- [access_requests](https://developers.asana.com/reference/createaccessrequest) (write only)
- [allocations](https://developers.asana.com/reference/createallocation) (write only)
- [custom_fields](https://developers.asana.com/reference/createcustomfield) (write only)
...
- [organization_exports](https://developers.asana.com/reference/createorganizationexport) (write only)
...
- [status_updates](https://developers.asana.com/reference/createstatusforobject) (write only)
