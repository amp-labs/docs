...
<Note>
 When performing write operations, the payload should be sent directly in the `record` field, not wrapped inside a `data` object as shown in Asana's API documentation.
</Note>
