...
4. Enter **App Name** and select the relevant app requirements .
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/f0942e9-asana1.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9d9c63f-Asana2.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/a88523c-asana.gif","This is some image...","Alt text"],"align":"center"}]}[/block]
