...
description: "Wire the Customer.io Journeys Track API to Ampersand using Basic Auth credentials and send proxy calls to track events and identify users at scale."
---
## What's supported
