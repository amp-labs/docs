---
title: "BigQuery"
description: "Connect BigQuery to Ampersand using service account credentials and enable read and proxy actions to sync any table in your dataset with incremental support."
---
