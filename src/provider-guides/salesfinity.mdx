---
title: Salesfinity
description: "Build a Salesfinity parallel dialer integration with Ampersand. Set up Read, Write, Subscribe, and Proxy Actions to sync contacts, calls, and campaigns."
---
