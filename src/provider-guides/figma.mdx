...
description: "Wire your app into Figma with Ampersand to read files and comments, write changes, subscribe to design updates, and proxy authenticated Figma API requests."
---
## What's Supported
...
![Alt text](/images/provider-guides/498f276-Figma1.gif)
...
6. Enter the scopes set for your application in _Figma_. For more details on the scopes, go to [Figma Authentication Scopes](https://www.figma.com/developers/api#authentication-scopes) document.
   ...
   ![Alt text](/images/provider-guides/53b2627-figma2.gif)
