...
6. Click **Create**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/491e169-Jira1.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5d6df49-Jira2.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1bb01c8-Jira3.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2a2bd9f-Screenshot_2024-06-26_at_16.51.34.png",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
6. Enter the scopes set for your application in _Atlassian_.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/53b7d93-atlassian1.gif","This is some image...","Alt text"],"align":"center"}]}[/block]
