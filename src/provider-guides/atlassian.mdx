---
title: "Atlassian"
description: "Register an Atlassian OAuth app, connect it to Ampersand, and enable read, write, and proxy actions with incremental sync against Jira and Confluence data."
---
## What's Supported
...
6. Enter the scopes set for your application in _Atlassian_. In addition to the scopes you configured, **you must add the `offline_access` scope.**
