...
description: "Create a DocuSign developer app and connect it to Ampersand to send proxy API calls for envelopes, templates, and signing workflows in your integration."
---
## What's Supported
