...
The Marketo connector supports writing in the following objects:
...
- [NamedAccounts](https://developer.adobe.com/marketo-apis/api/mapi/#tag/Named-Accounts)
- [Opportunities](https://developer.adobe.com/marketo-apis/api/mapi/#tag/Opportunities)
- [SalesPersons](https://developer.adobe.com/marketo-apis/api/mapi/#tag/Sales-Persons)
