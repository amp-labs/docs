---
title: Four/Four
description: "Use Ampersand to build a Four/Four integration that reads insights, writes updates, subscribes to signals, and proxies calls to the Four/Four platform API."
---
