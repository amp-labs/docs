---
title: AWS
description: "Configure AWS credentials in Ampersand and enable read, write, and proxy actions against identity store objects such as users, groups, and applications."
---
## What's supported
