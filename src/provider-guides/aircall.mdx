...
description: "Register an Aircall OAuth app, connect it to Ampersand, and enable read, write, and proxy actions across contacts, users, calls, numbers, and more."
---
