...
- [Read Actions](/read-actions), including full historic backfill. Please note that incremental read is not supported, a full read of the LinkedIn instance will be done for each scheduled read.
