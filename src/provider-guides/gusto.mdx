---
title: Gusto
description: "Connect Gusto to your app with Ampersand to read employees and payroll, write updates, subscribe to HR events, and proxy authenticated calls to the Gusto API."
---
