...
description: "Integrate SolarWinds Service Desk via Ampersand to run Read, Write, Subscribe, and Proxy Actions on tickets, assets, and IT service management data."
---
## What's supported
