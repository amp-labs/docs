...
The Solarwinds connector support writing to and reading from the following objects:
...
For an example manifest file of a Smartlead integration, visit our [samples repo on Github](https://github.com/amp-labs/samples/blob/main/solarwindsServiceDesk/amp.yaml).
