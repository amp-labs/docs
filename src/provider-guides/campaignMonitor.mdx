...
description: "Register a Campaign Monitor OAuth app in Ampersand and enable read, write, and proxy actions to sync subscribers, lists, and campaigns with Campaign Monitor."
---
