---
title: Odoo
description: "Build an Odoo integration with Ampersand. Configure Read, Write, Subscribe, and Proxy Actions to sync ERP records across sales, inventory, and CRM."
---
