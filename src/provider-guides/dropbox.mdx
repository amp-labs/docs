...
description: "Set up a Dropbox OAuth app with the Ampersand redirect URI and connect it to enable proxy API calls for files, folders, and sharing in your integration."
---
## What's Supported
...
![Alt text](/images/provider-guides/6d3f25b-dropbox-app-create.gif)
...
![Alt text](/images/provider-guides/b546e59-dropbox-scopes.gif)
...
![Alt text](/images/provider-guides/91eaa5d-dropbox-redirect-uri.gif)
...
![Alt text](/images/provider-guides/b4cc0e4-dropbox2.gif)
