---
title: Coupa
description: "Create a Coupa OAuth2 client and connect it to Ampersand to send proxy API calls against your customer Coupa spend management instance domain."
---
