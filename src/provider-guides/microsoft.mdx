...
description: "Add a Microsoft integration to your product using Ampersand, following this guide on authentication and Read, Write, Subscribe, and Proxy action usage."
---
