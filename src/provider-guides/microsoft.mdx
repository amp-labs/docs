...
export const rows = [
  {
    label: "calendars", read: true, write: true, subscribe: false,
    href: "https://learn.microsoft.com/en-us/graph/api/resources/calendar?view=graph-rest-1.0",
  }, {
    label: "me/events", read: true, write: true, subscribe: false,
    href: "https://learn.microsoft.com/en-us/graph/api/resources/event?view=graph-rest-1.0",
  }, {
    label: "me/messages", read: true, write: true, subscribe: false,
    href: "https://learn.microsoft.com/en-us/graph/api/resources/message?view=graph-rest-1.0",
  }, {
    label: "users", read: true, write: true, subscribe: false,
    href: "https://learn.microsoft.com/en-us/graph/api/resources/user?view=graph-rest-1.0"
  }, {
    label: "AMPERSAND-sentMessages", read: true, write: false, subscribe: false,
    display: "MailFolder: Sent items.",
    href: "https://learn.microsoft.com/en-us/graph/api/resources/message?view=graph-rest-1.0",
  }, {
    label: "AMPERSAND-messages", read: true, write: true, subscribe: false,
    display: "MailFolder: Inbox. Write sends an email.",
    href: "https://learn.microsoft.com/en-us/graph/api/resources/message?view=graph-rest-1.0",
  }, {
    label: "AMPERSAND-drafts", read: true, write: true, subscribe: false,
    display: "MailFolder: Drafts.",
    href: "https://learn.microsoft.com/en-us/graph/api/resources/message?view=graph-rest-1.0",
  },
]
...
11. Click **Add a permission** and choose the required scopes. You must include the **offline_access** scope.

12. Generate

    ![Microsoft App Creation](/images/provider-guides/e0b0327-Microsoft1.gif)
