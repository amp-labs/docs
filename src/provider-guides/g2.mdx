---
title: G2
description: "Set up a G2 integration with Ampersand to read buyer intent data, write records, subscribe to review activity, and proxy authenticated requests to the G2 API."
---
## What's supported
