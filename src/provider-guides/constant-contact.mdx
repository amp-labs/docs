...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/690cde2-constantcontact1.gif",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e7de3f-constantcontact2.gif",
        null,
        "Constant Contact Client ID and Secret"
      ],
      "align": "center"
...
5. Enter the previously obtained **Client ID** and **Client Secret** in the respective fields.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/8a3c47c-constantcontact3.gif",null,"Ampersand Constant Contact Integration"],"align":"center"}]}[/block]
