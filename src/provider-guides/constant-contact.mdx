...
![Constant Contact Client ID and Secret](https://files.readme.io/690cde2-constantcontact1.gif)
...
![Constant Contact Client ID and Secret](https://files.readme.io/6e7de3f-constantcontact2.gif)
...
5. Enter the previously obtained **Client ID** and **Client Secret** in the respective fields.
   ...
   ![Ampersand Constant Contact Integration](https://files.readme.io/8a3c47c-constantcontact3.gif)
