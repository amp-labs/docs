---
title: Amplemarket
description: "Set up Amplemarket API credentials, connect them to Ampersand, and use proxy actions to call the Amplemarket API from your integration with a shared client."
---
## What's supported
