---
title: Freshdesk
description: "Build a Freshdesk integration through Ampersand to sync tickets and contacts, push updates, listen to support events, and proxy requests to the Freshdesk API."
---
