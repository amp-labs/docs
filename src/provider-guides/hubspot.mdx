...
New Project Apps are [limited to 25 installs
...
<Note>
  ...
  where you want to create the app. Make sure to select the developer account.
</Note>
...
- Choose how to distribute your application: **Marketplace** (See [HubSpot's distribution options](https://developers.hubspot.com/docs/apps/developer-platform/build-apps/app-configuration#distribution))
