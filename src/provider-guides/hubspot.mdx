---
title: "HubSpot"
description: "Builder guide for integrating your app with HubSpot through Ampersand, covering Read, Write, Subscribe, and Proxy actions plus auth setup."
---
...
that follow the convention `AMPERSAND-event-occurrences-<EVENT_TYPE>`.
<Note>
