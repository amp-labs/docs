...
If you want to know the users in your customer's Hubspot workspace, enable the `crm.objects.users.read` scope for your [HubSpot App](/provider-guides/hubspot#creating-a-hubspot-app), and add `users` as an object in `amp.yaml`.
...
### Obtaining Client Id, Client Secret, and Scopes
