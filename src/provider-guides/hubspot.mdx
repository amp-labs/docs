...
<Warning>
  We recommend using Method 3 for creating new apps; [HubSpot will not push any
  new features to Legacy
  Apps](https://developers.hubspot.com/docs/apps/developer-platform/build-apps/overview).
</Warning>
...
This is HubSpot's recommended method for creating new apps. Use
this if you prefer a CLI-based workflow or plan to build advanced
features like UI extensions in the future.

{" "}

<Note>
  For basic OAuth integrations, Method 2 and Method 3 are functionally
  equivalent. Choose based on your preference: web UI (Method 2) or CLI (Method
  3).
</Note>
...
7. Create a project: `hs project create` and follow the prompts
...
- Choose how to distribute your application: **Privately**
...
Open the folder where project was created and edit `src/app/app-hsmeta.json` to add the redirect URL:
