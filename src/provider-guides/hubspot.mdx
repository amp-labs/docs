...
2. Click **Create an app**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/a8c2c6f-hubspot1.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
...
3. In the **Redirect URLs** section, add the Ampersand Callback URL: `https://api.withampersand.com/callbacks/v1/oauth`.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/013943e-hubspot3.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
4. In the **Scopes** section, select the scopes you'd like to use in your application. You will need add the same scopes in Ampersand to set up your app. 
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/1b56fb4-hubspot5.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
...
6. Enter the scopes set for your application in HubSpot.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/f4ada70-hubspot6.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
