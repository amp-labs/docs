---
title: Crunchbase
description: "Add Crunchbase to your Ampersand integration using API key authentication and route proxy actions to the Crunchbase company and funding data API."
---
## What's supported
