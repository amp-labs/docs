...
description: "Connect Formstack to your app through Ampersand to read submissions, write form data, subscribe to new responses, and proxy requests to the Formstack API."
---
## What's Supported
...
![Ampersand Project Selection](/images/provider-guides/07152ce-bvbkzt_Ojjjfx1Y4vCIX5zwm.png)
...
![Ampersand Project Selection](/images/provider-guides/07ec617-3yqV0oouqUK9tn_QyLErcYOM.png)
...
5. Enter the previously obtained **Client ID** in the **Client ID** field and the **Client Secret** in the **Client Secret** field.
   ...
   ![Ampersand Project Selection](/images/provider-guides/78a6694-formstack.gif)
