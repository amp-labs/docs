...
![Ampersand Project Selection](https://files.readme.io/07152ce-bvbkzt_Ojjjfx1Y4vCIX5zwm.png)
...
![Ampersand Project Selection](https://files.readme.io/07ec617-3yqV0oouqUK9tn_QyLErcYOM.png)
...
5. Enter the previously obtained **Client ID** in the **Client ID** field and the **Client Secret** in the **Client Secret** field.
   ...
   ![Ampersand Project Selection](https://files.readme.io/78a6694-formstack.gif)
