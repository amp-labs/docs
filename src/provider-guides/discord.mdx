...
description: "Create a Discord OAuth app and connect it to Ampersand so your integration can send proxy API calls to the Discord platform on behalf of customers."
---
## What's Supported
...
4. Enter in your app details and click the **Save changes** button.
   ...
   ![Alt text](/images/provider-guides/4930f29-discord1.gif)
...
![Alt text](/images/provider-guides/2876661-discord2.gif)
