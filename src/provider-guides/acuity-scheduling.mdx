...
![Acuity Scheduling App Creation](https://files.readme.io/284e851-acuity1.gif)
...
![Acuity Scheduling App Creation](https://files.readme.io/bfdd528-acuity2.jpeg)
...
6. Enter the scopes set for your application in _Acuity Scheduling_.
   ...
   ![Ampersand Integration](https://files.readme.io/f4bc1a4-acuity3.gif)
