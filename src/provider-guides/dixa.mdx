---
title: Dixa
description: "Add Dixa to your Ampersand integration with API key authentication and enable read, write, and proxy actions across conversations, contacts, and agents."
---
## What's supported
