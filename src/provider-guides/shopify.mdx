...
Some Shopify scopes and objects (for example, customer data) may require additional approval and configuration. If you see errors like “This app is not approved to access the Customer object”, review Shopify’s [protected customer data requirements](https://shopify.dev/docs/apps/launch/protected-customer-data) and ensure your app is eligible for the data you’re requesting.

If your integration needs access to older orders, Shopify may require additional scopes (for example, `read_all_orders`). See Shopify’s [Orders API documentation](https://shopify.dev/docs/api/admin-rest/latest/resources/order) for details.
