...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1cd5402-pinterest1.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0f94f77-pinterest2.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
6. Enter the scopes set for your application in _Pinterest_. For more details on the scopes, go to the [Pinterest API Scopes](https://developers.pinterest.com/docs/getting-started/authentication-and-scopes/) documentation.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/5acff64-pinterest3.gif","This is some image...","Alt text"],"align":"center"}]}[/block]
