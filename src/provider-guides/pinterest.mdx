...
description: "Connect Pinterest to your product using Ampersand. Configure Read, Write, Subscribe, and Proxy Actions to sync boards, pins, ads, and account activity."
---
## What's supported
