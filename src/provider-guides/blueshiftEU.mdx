...
- [Proxy Actions](/define-integrations/proxy-actions), using the base URL `https://api.eu.getblueshift.com/api`.
...
- Start making [Proxy Calls](/define-integrations/proxy-actions), and Ampersand will automatically attach the correct header required by Basic Auth. Please note that this connector's base URL is `https://api.eu.getblueshift.com/api`.
