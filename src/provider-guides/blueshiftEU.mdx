---
title: Blueshift (EU)
description: "Connect the Blueshift EU region to Ampersand using API credentials and enable proxy actions that route calls through the Blueshift EU endpoints for your app."
---
## What's supported
