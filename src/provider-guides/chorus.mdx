---
title: Chorus
description: "Set up a Chorus connector in Ampersand using Basic auth to power read, write, and proxy actions across calls, emails, scorecards, and other Chorus objects."
---
