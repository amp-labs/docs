---
title: Insightly
description: "Learn how developers wire up Insightly to their SaaS app via Ampersand, including OAuth setup and supported Read, Write, Subscribe, and Proxy actions."
---
## What's supported
