...
description: "Learn how to register an Acuity Scheduling OAuth app, wire credentials into Ampersand, and enable read, write, and proxy actions on scheduling objects."
---
## What's supported
