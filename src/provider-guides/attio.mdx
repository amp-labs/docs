...
- [Read Actions](/define-integrations/read-actions), including full historic backfill.
...
<Tip>Coming soon: support for People, Companies, Users, Deals, and custom objects.</Tip>
