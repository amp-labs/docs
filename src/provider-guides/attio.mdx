...
### Supported Objects
The Attio connector supports reading from the following objects:
...
The Attio connector supports writing from the following objects:
...
- Create a manifest file like the [example](https://github.com/amp-labs/samples/blob/main/attio/amp.yaml), see [Define Integrations](/define-integrations/overview) for more info.
