...
excerpt: ""
hidden: false
createdAt: "Thu Jul 18 2024 06:07:07 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Wed Jul 24 2024 23:59:42 GMT+0000 (Coordinated Universal Time)"
---
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f8a2ac0-attio1.gif",
        null,
        "Attio App Creation"
      ],
      "align": "center"
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/07458e9-attio2.gif",null,"Ampersand Integration"],"align":"center"}]}[/block]
