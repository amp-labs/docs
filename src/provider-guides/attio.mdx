---
title: "Attio"
description: "Create an Attio OAuth app, connect it through Ampersand, and enable read, write, and proxy actions with incremental sync across your Attio CRM objects."
---
## What's Supported
