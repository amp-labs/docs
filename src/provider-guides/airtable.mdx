---
title: "Airtable"
description: "Follow this Ampersand guide to create an Airtable OAuth integration, capture the client credentials, and enable proxy actions against the Airtable API."
---
