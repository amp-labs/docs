...
5. You will see the **Client ID**, Click on **Generate client secret** to generate client secret. Note these credentials, as you will need them to connect your app to Ampersand.
6. Select the appropriate permissions(scopes) for your application.
7. Provide a support email, privacy policy, and terms of service.
