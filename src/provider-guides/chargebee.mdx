---
title: Chargebee
description: "Set up a Chargebee integration with Ampersand using Basic auth and an API key, then power read, write, and proxy actions across billing objects."
---
