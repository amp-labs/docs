---
title: "Gorgias"
description: "Set up a Gorgias integration using Ampersand to read tickets and customers, write updates, subscribe to helpdesk events, and proxy requests to the Gorgias API."
---
