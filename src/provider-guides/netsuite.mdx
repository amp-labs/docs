...
6. Enter the scopes set for your application in _NetSuite_. The following scopes are available:
   - `restlets` (if you selected **RESTlets** in the NetSuite integration)
   - `rest_webservices` (if you selected **REST Web Services** in the NetSuite integration)
