...
5. Click **Create App**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/62de7c7-clickup1.gif","This is some image...","Alt text"],"align":"center"}]}[/block]
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/d1a4278-clickup2.gif","This is some image...","Alt text"],"align":"center"}]}[/block]
