...
description: "Create a ClickUp OAuth app and connect it to Ampersand to power read and proxy actions across tasks, lists, and other ClickUp workspace objects."
---
## What's Supported
