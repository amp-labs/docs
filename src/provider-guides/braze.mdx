---
title: Braze
description: "Configure Braze API credentials in Ampersand and enable read, write, and proxy actions to sync contacts and campaigns with your customer Braze workspace."
---
## What's supported
