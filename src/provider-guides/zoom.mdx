...
5. In the **OAuth Information** section, enter the Ampersand redirect URL: `https://api.withampersand.com/callbacks/v1/oauth`.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/5cad59a-zoom1.gif",null,"Creating Zoom App"],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e6d1a69-zoom3.jpeg",
        null,
        "Ampersand Project"
      ],
      "align": "center"
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/4669432-zoom2.gif",null,"Adding Zoom Credentials"],"align":"center"}]}[/block]
