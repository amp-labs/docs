...
description: "Build a Zoom integration using Ampersand and execute Read, Write, Subscribe, and Proxy Actions across meetings, webinars, recordings, and user data."
---
## What's Supported
...
- [meeting_summaries](https://developers.zoom.us/docs/api/meetings/#tag/summaries/get/meetings/meeting_summaries) (read only)
