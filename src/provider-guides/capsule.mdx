...
description: "Set up a Capsule CRM OAuth app, connect it via Ampersand, and enable read, write, and proxy actions with incremental sync across contacts, boards, and deals."
---
## What's Supported
