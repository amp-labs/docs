...
5. Click **Save**. You will see the **Client ID** and **Client Secret** in the app details. Note these credentials, as you will need them to connect your app to Ampersand.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/596ef48-capsulecrm1.gif",null,"Capsule CRM App Creation"],"align":"center"}]}[/block]
...
6. Enter the scopes set for your application in _Capsule CRM_.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/30e4ef5-capsulcrm2.gif",null,"Ampersand Integration"],"align":"center"}]}[/block]
