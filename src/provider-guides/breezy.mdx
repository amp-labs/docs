---
title: "Breezy"
description: "Connect Breezy HR to Ampersand using OAuth, read positions, candidates, companies, departments, and pipelines, and write to positions via the API."
---
