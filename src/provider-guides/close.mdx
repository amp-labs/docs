---
title: "Close"
description: "Connect Close CRM to Ampersand using OAuth, then use read, write, and proxy actions across leads, contacts, opportunities, activities, and pipelines."
---
...
To integrate Close with Ampersand, you need to [Create a Close Account](#create-a-close-account) and obtain the following credentials from your Close App:
