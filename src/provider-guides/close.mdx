---
title: "Close"
description: "Build a Close CRM integration with Ampersand by creating an OAuth app, then use read, write, and proxy actions for leads, contacts, and opportunities."
---
