...
5. Click **Create**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/ddba26c-RsGLizoLnbDCE3ichwJvAvvH.png",null,"Ampersand Project Selection"],"align":"center"}]}[/block]
...
5. Enter the previously obtained **App ID** in the **Client ID** field and the **App Secret** in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/1d847cc-helpscout1.gif",null,"Ampersand Project Selection"],"align":"center"}]}[/block]
