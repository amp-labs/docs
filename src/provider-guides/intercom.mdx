...
- [Read Actions](/define-integrations/read-actions), including full historic backfill. Incremental read is supported for conversations, for all other objects a full read of the Intercom instance will be done for each scheduled read.
