...
- [Read Actions](/define-integrations/read-actions), including full historic backfill. Incremental read is supported for conversations, contacts, activity_logs and tickets, for all other objects a full read of the Intercom instance will be done for each scheduled read.
...
- [Tickets](https://developers.intercom.com/docs/references/rest-api/api.intercom.io/tickets/ticket) (incremental read, without full historic backfill)
