...
- [Read Actions](/define-integrations/read-actions), including full historic backfill. Please note that incremental read is not supported, a full read of the Intercom instance will be done for each scheduled read.
- [Write Actions](/define-integrations/write-actions).
- [Proxy Actions](/define-integrations/proxy-actions), using the base URL `https://api.intercom.io`.
...
- [Contacts](https://developers.intercom.com/docs/references/rest-api/api.intercom.io/contacts/contact)
- [Conversations](https://developers.intercom.com/docs/references/rest-api/api.intercom.io/conversations/conversation)
...
![Alt text](/images/provider-guides/d07cbbe-intercom3.gif)
...
4. In the **Redirect URL** section, click **Add URL** and add the Ampersand redirect URL: `https://api.withampersand.com/callbacks/v1/oauth`.
   ...
   ![Alt text](/images/provider-guides/10f932e-intercom1.gif)
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   ![Alt text](/images/provider-guides/b87b1d9-intercom2.gif)
6. Click **Save Changes**.

## Using the connector

To start integrating with Intercom:
- Create a manifest file like the [example](https://github.com/amp-labs/samples/blob/main/intercom/amp.yaml), see [Define Integrations](/define-integrations/overview) for more info.
