...
- [Read Actions](/define-integrations/read-actions), including full historic backfill. Incremental read is supported for conversations, for the rest a full read of the Intercom instance will be done for each scheduled read.
