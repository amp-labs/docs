...
excerpt: ""
hidden: false
createdAt: "Mon Jun 03 2024 10:06:18 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Fri Jul 19 2024 21:55:08 GMT+0000 (Coordinated Universal Time)"
---
## Getting Started
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d07cbbe-intercom3.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
4. In the **Redirect URL** section, click **Add URL** and add the Ampersand redirect URL: `https://api.withampersand.com/callbacks/v1/oauth`.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/10f932e-intercom1.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/b87b1d9-intercom2.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
