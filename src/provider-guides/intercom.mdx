...
- [Read Actions](/define-integrations/read-actions), including full historic backfill. Please incremental read is not supported, a full read of the Intercom instance will be done for each scheduled read.
