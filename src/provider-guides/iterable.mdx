---
title: Iterable
description: "Connect Iterable to your product using Ampersand with this builder guide, outlining auth flow and support for Read, Write, Subscribe, and Proxy actions."
---
## What's supported
