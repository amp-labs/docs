...
*If you are using `@amp-labs/react` **v2.14.0** or above*:
...
*If you are using `@amp-labs/react` versions below **2.14.0**:*
...
5. Enter the following information:
    - *Client ID*: enter the Consumer Key for the External Client App, obtained from [Step 4. Create Extenal Client App](#4-create-external-client-app).
    - *Client Secret*: enter the Consumer Secret for the External Client App, obtained from [Step 4. Create Extenal Client App](#4-create-external-client-app)
    - *Package Install URL*: enter the Package Install URL, obtained from [Step 7. Build the Package Install URL](#7-build-the-package-install-url)
