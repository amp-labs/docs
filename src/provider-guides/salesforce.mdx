...
- Create a manifest file like the [example](https://github.com/amp-labs/samples/blob/main/salesforce/amp.yaml), see [Define Integrations](/overview) for more info.
