---
title: "CallRail"
description: "Connect CallRail to Ampersand with an API key, then use read, write, and proxy actions across calls, companies, form submissions, leads, and notifications."
---
