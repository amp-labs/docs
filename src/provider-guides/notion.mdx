...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f58207-notion1.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8cc7845-notion3.jpeg",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
5. Enter the previously obtained _OAuth Client ID_ in the **Client ID** field and _OAuth Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/1594a46-notion2.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
