...
![Alt text](https://files.readme.io/4f58207-notion1.gif)
...
![Alt text](https://files.readme.io/8cc7845-notion3.jpeg)
...
5. Enter the previously obtained _OAuth Client ID_ in the **Client ID** field and _OAuth Client Secret_ in the **Client Secret** field.
   ...
   ![Alt text](https://files.readme.io/1594a46-notion2.gif)
