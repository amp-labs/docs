...
description: "Connect CloudTalk to Ampersand using Basic Auth API key credentials and enable read, write, and proxy actions across your call center data objects."
---
