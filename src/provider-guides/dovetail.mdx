---
title: "Dovetail"
description: "Add Dovetail to Ampersand using API key authentication and send proxy actions to any Dovetail Public API endpoint for projects, notes, and insights."
---
## What's supported
