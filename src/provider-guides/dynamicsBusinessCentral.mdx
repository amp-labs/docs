...
description: "Register a Microsoft Entra app for Dynamics 365 Business Central and connect it to Ampersand for read, write, and proxy actions on ERP records."
---
