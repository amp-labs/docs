...
Your customer's Salesforce administrator creates an **External Client App** with JWT Bearer flow enabled, uploads an X.509 certificate, and associates a Profile that pre-authorizes the integration user. The full steps are documented in the [customer guide](/customer-guides/salesforce-jwt).
