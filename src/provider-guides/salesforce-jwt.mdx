...
excerpt: ""
hidden: false
description: "Set up a Salesforce integration with JWT authentication using Ampersand. Configure Read, Write, Subscribe, and Proxy Actions with server-to-server auth."
---
