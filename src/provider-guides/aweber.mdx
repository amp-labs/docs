...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cc4313f-Aweber1.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ce82da-Aweber2.jpeg",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
6. Enter the scopes set for your application in _AWeber_.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/f4ec7a9-aweber3.gif","This is some image...","Alt text"],"align":"center"}]}[/block]
