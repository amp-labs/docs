---
title: "Domo"
description: "Connect Domo to Ampersand using OAuth2 Client Credentials without setting up a provider app, and route proxy calls to the Domo analytics platform API."
---
