...
description: "Register a Box OAuth application, share the client credentials with Ampersand, and enable proxy actions to call the Box API for file and folder operations."
---
## What's Supported
...
9. Click **Create App**.
   ...
   ![Alt text](/images/provider-guides/3d26068-box1.gif)
...
![Alt text](/images/provider-guides/57a8db3-box2.gif)
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   ![Alt text](/images/provider-guides/c5dcec5-box3.gif)
