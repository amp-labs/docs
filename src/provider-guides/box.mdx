...
excerpt: ""
hidden: false
createdAt: "Wed Jul 03 2024 15:21:19 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Thu Jul 18 2024 06:12:36 GMT+0000 (Coordinated Universal Time)"
---
...
9. Click **Create App**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/3d26068-box1.gif","This is some image...","Alt text"],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/57a8db3-box2.gif",
        "This is some image...",
        "Alt text"
      ],
      "align": "center",
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/c5dcec5-box3.gif","This is some image...","Alt text"],"align":"center"}]}[/block]
