...
excerpt: ""
hidden: false
description: "Set up a NetSuite (M2M) integration in your SaaS app with Ampersand, covering machine auth plus Read, Write, Subscribe, and Proxy action support."
---
## What's Supported
