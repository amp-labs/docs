...
![Teamwork App Credentials](https://files.readme.io/62552cd-teamwork1.gif)
...
5. Enter the previously obtained **Client ID** and **Client Secret** in the respective fields.
   ...
   ![Ampersand Constant Contact Integration](https://files.readme.io/57fdc27-teamwork2.gif)
