...
Once you app is created, you can click on the app and go to the **Credentials** tab to get **Client ID** and **Client Secret** for your app.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/62552cd-teamwork1.gif",
        null,
        "Teamwork App Credentials"
      ],
      "align": "center"
    }
  ]
...
5. Enter the previously obtained **Client ID** and **Client Secret** in the respective fields.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/57fdc27-teamwork2.gif",null,"Ampersand Constant Contact Integration"],"align":"center"}]}[/block]
