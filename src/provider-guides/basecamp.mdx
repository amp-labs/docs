---
title: "Basecamp"
description: "Connect Basecamp to Ampersand using OAuth via a 37signals Launchpad app, then call any Basecamp API endpoint through proxy actions with an account ID."
---
