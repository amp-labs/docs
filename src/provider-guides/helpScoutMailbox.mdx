...
description: "Wire Help Scout Mailbox into your app with Ampersand to read conversations, write replies, subscribe to inbox events, and proxy requests to the Help Scout API."
---
## What's Supported
...
5. Click **Create**.
   ...
   ![Ampersand Project Selection](/images/provider-guides/ddba26c-RsGLizoLnbDCE3ichwJvAvvH.png)
...
5. Enter the previously obtained **App ID** in the **Client ID** field and the **App Secret** in the **Client Secret** field.
   ...
   ![Ampersand Project Selection](/images/provider-guides/1d847cc-helpscout1.gif)
