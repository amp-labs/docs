...
description: "Integrate Zendesk Support via Ampersand and run Read, Write, Subscribe, and Proxy Actions on tickets, users, organizations, and help desk conversations."
---
