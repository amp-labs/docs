...
Zendesk Support connector supports writing to and reading from 48 objects. All of them come from [Ticketing module](https://developer.zendesk.com/api-reference/ticketing/introduction).
Ticket objects:
