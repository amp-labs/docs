...
- [Proxy Actions](/define-integrations/proxy-actions), using the base URL https://api.join.me.

## Before You Get Started

To connect Join Me with Ampersand, you need [a Join Me Account](https://api.join.me).
