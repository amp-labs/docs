...
- Calls and Transcripts (incremental read in private preview, contact support@withampersand.com).

> **Important:** To read `Calls`, ensure that your Gong application includes the `api:calls:read:extensive` scope. This scope is specifically required for reading calls.
