---
title: "Dropbox Sign"
description: "Register a Dropbox Sign OAuth app and link it to Ampersand to run read, write, and proxy actions for signature requests, templates, and account data."
---
