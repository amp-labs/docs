---
title: "Freshchat"
description: "Integrate Freshchat into your app with Ampersand to read conversations, write messages, subscribe to chat events, and proxy authenticated Freshchat API calls."
---
## What's supported
