...
Refer to [Salesloft API documentation](https://developers.salesloft.com/docs/api).
The Salesloft connector supports writing to and reading from the following 47 objects:
- Account Stages
- Account Tiers
- Accounts
