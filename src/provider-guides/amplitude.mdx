---
title: Amplitude
description: "Configure Amplitude API credentials in Ampersand and enable read, write, and proxy actions so your product can sync event data and cohorts with Amplitude."
---
## What's supported
