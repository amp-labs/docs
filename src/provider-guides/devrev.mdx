---
title: DevRev
description: "Set up DevRev in Ampersand using a Personal Access Token to enable read, write, and proxy actions across works, parts, and other DevRev objects."
---
