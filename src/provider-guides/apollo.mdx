...
- [Read Actions](/read-actions), including full historic backfill. Please note that incremental read is supported for `contacts` and `accounts` only. For all other objects, a full read will be done each time.
