...
- [Read Actions](/read-actions), including full historic backfill. Please note that incremental read is not supported, a full read of the Apollo instance will be done for each scheduled read.
...
- Create a manifest file like the [example](https://github.com/amp-labs/samples/blob/main/apollo/amp.yaml), see [Define Integrations](/overview) for more info.
