---
title: "ConnectWise integration setup and supported actions"
description: "Set up the ConnectWise Manage connector on Ampersand with supported read, write, subscribe, and proxy actions, plus custom fields and communication items."
---
## What's supported
