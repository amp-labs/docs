---
title: ConnectWise
description: "Set up ConnectWise in Ampersand with Basic Auth credentials to enable read, write, subscribe, and proxy actions against the ConnectWise Manage API."
---
## What's supported
