---
title: ChartMogul
description: "Connect ChartMogul to Ampersand using Basic Auth credentials and use proxy actions to call the ChartMogul API from your subscription analytics integration."
---
## What's supported
