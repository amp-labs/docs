---
title: Hive
description: "Build a Hive integration via Ampersand to read projects and tasks, write updates, subscribe to workspace activity events, and proxy calls to the Hive REST API."
---
## What's supported
