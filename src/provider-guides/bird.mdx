...
description: "Set up Bird (MessageBird) API credentials in Ampersand and enable proxy actions so your integration can call the Bird API for messaging on customer accounts."
---
## What's supported
