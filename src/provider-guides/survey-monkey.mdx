...
4. Click **Create App**.
   ...
   ![SurveyMonkey App Creation](/images/05fd68a-surveymonkey1.gif)
...
9. Click **Update Scopes**.
   ...
   ![SurveyMonkey App Scopes](/images/74c56bc-surveymonkey2.gif)
...
2. Select the project where you want to add the SurveyMonkey App.
   ...
   ![Ampersand Project Selection](/images/2fd1283-Ampersand.png)
...
5. Enter the previously obtained **Client ID** in the **Client ID** field and the **Client Secret** in the **Client Secret** field.
   ...
   ![SurveyMonkey Integration in Ampersand](/images/67af4d6-surveymonkey3.gif)
