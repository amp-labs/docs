...
4. Click **Create App**.
   ...
   ![SurveyMonkey App Details](https://files.readme.io/05fd68a-surveymonkey1.gif)
...
9. Click **Update Scopes**.
   ...
   ![SurveyMonkey App Details](https://files.readme.io/74c56bc-surveymonkey2.gif)
...
5. Enter the previously obtained **Client ID** in the **Client ID** field and the **Client Secret** in the **Client Secret** field.
   ...
   ![Ampersand Project Selection](https://files.readme.io/67af4d6-surveymonkey3.gif)
