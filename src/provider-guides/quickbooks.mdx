...
For development and testing, QuickBooks provides a sandbox environment. To use Proxy Actions against the sandbox, specify `quickbooksSandbox` as the provider (instead of `quickbooks`) in your integration.
