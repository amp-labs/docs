---
title: QuickBooks
description: "Integrate QuickBooks accounting with your app through Ampersand. Use Read, Write, Subscribe, and Proxy Actions to sync invoices, customers, and payments."
---
...
4. Select _QuickBooks_ from the **Provider** list, or _QuickBooks Sandbox_ if you are setting up a development integration.
