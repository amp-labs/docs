...
6. Enter the **scopes** required for your application in **Scopes**. For details on scopes, refer to the [QuickBooks Scopes](https://developer.intuit.com/app/developer/qbo/docs/learn/scopes) guide.
