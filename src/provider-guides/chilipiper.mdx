---
title: ChiliPiper
description: "Configure a ChiliPiper integration in Ampersand with API key auth to enable read, write, and proxy actions against the ChiliPiper scheduling API."
---
## What's supported
