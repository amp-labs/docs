---
title: "GitLab"
description: "Build a GitLab integration through Ampersand to read projects and merge requests, write updates, listen to pipeline events, and proxy GitLab API calls."
---
