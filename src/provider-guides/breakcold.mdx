---
title: Breakcold
description: "Wire up Breakcold API credentials in Ampersand and enable read, write, and proxy actions to sync leads, campaigns, and CRM records with your Breakcold data."
---
## What's Supported
