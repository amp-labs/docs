---
title: "Survey Monkey"
description: "Add a Survey Monkey integration to your app with Ampersand and run Read, Write, Subscribe, and Proxy Actions on surveys, responses, and collector data."
---
## What's Supported
...
5. Enter the previously obtained **Client ID** in the **Client ID** field and the **Client Secret** in the **Client Secret** field.
   ...
   ![Ampersand Project Selection](/images/provider-guides/67af4d6-surveymonkey3.gif)
