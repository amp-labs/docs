---
title: "SurveyMonkey"
description: "Connect SurveyMonkey to Ampersand using OAuth, then use read, write, and proxy actions across surveys, contacts, contact lists, groups, and response counts."
---
