---
title: Okta
description: "Integrate Okta identity data with your app via Ampersand. Use Read, Write, Subscribe, and Proxy Actions to sync users, groups, and directory events."
---
## What's supported
