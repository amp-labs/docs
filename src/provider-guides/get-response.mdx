...
excerpt: ""
hidden: false
createdAt: "Wed Jul 31 2024 08:36:07 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Thu Aug 01 2024 00:49:54 GMT+0000 (Coordinated Universal Time)"
---
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0696f04-GetResponse.gif",
        null,
        "GetResponse API Key"
      ],
      "align": "center"
...
5. Enter the previously obtained _Client ID_ in the **Client ID** field and the _Client Secret_ in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/f8f25dc-getresponse2.gif",null,"Ampersand GetResponse Integration"],"align":"center"}]}[/block]
