---
title: HappyFox
description: "Integrate HappyFox with your product using Ampersand to sync tickets and contacts, write updates, subscribe to support events, and proxy HappyFox API calls."
---
## What's Supported
