...
The HapppyFox connector supports reading from the following objects:
...
To define an integration for Happyfox, create a manifest file that looks like this: https://github.com/amp-labs/samples/blob/main/happyfox/amp.yaml
