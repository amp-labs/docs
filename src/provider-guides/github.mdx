---
title: "GitHub"
description: "Integrate GitHub with your app using Ampersand to read repos and issues, write commits, subscribe to webhook events, and proxy GitHub REST API requests."
---
## What's Supported
