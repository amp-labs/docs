...
excerpt: ""
hidden: false
createdAt: "Tue Jul 16 2024 11:24:23 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Fri Jul 19 2024 21:46:55 GMT+0000 (Coordinated Universal Time)"
description: "Integrate Smartsheet using Ampersand to execute Read, Write, Subscribe, and Proxy Actions across sheets, rows, and collaborative workspaces in your app."
---
## What's Supported
...
![Smartsheet App Creation](/images/provider-guides/2bdccb1-smartsheet1.gif)
...
2. Select the project where you want to add the Smartsheet App.
   ...
   ![Ampersand Project Selection](/images/provider-guides/66e7c1d-Ampersand.png)
...
6. Enter the scopes set for your application in **Smartsheet**.
   ...
   ![Ampersand Project Selection](/images/provider-guides/809a626-smartsheet2.gif)
