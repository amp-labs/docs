...
![Smartsheet App Creation](https://files.readme.io/2bdccb1-smartsheet1.gif)
...
2. Select the project where you want to add the Smartsheet App.
   ...
   ![Ampersand Project Selection](https://files.readme.io/66e7c1d-Ampersand.png)
...
6. Enter the scopes set for your application in **Smartsheet**.
   ...
   ![Ampersand Project Selection](https://files.readme.io/809a626-smartsheet2.gif)
