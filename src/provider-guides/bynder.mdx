...
description: "Register a Bynder OAuth application, share the client credentials with Ampersand, and enable proxy actions to call the Bynder DAM API on your customers assets."
---
## What's Supported
