...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/af13a22-bynder1.gif",
        null,
        "Bynder App Creation"
      ],
      "align": "center"
...
6. Enter the scopes set for your application in _Bynder_.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/3a0b8e9-bynder2.gif",null,"Ampersand Integration"],"align":"center"}]}[/block]
