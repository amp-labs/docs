---
title: Anthropic
description: "Wire up Anthropic API credentials in Ampersand and enable proxy actions so your product can forward prompts to the Anthropic API through a managed connection."
---
## What's supported
