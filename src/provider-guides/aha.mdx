...
3. On the _Personal_ settings page, click **Developer**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/bcc83d7-Aha1.gif",null,"Aha! App Creation"],"align":"center"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bbd5309-Aha2.gif",
        null,
        "Aha! App Scopes"
      ],
      "align": "center"
...
5. Enter the previously obtained **Client ID / Application ID** in the **Client ID** field and the **Client Secret** in the **Client Secret** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/c425479-Aha3.gif",null,"Ampersand Project Selection"],"align":"center"}]}[/block]
