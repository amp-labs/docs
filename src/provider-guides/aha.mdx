...
description: "Configure an Aha! OAuth application, share credentials with Ampersand, and start using read, write, and proxy actions against product management objects."
---
## What's Supported
