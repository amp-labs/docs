---
title: Bentley
description: "Register a Bentley OAuth app, share the credentials with Ampersand, and enable read, write, and proxy actions across iTwins, jobs, and reality data objects."
---
