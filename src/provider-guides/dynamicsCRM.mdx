...
description: "Connect your app to Dynamics 365 CRM through Ampersand to read records, write updates, subscribe to change events, and proxy calls to the CRM API."
---
