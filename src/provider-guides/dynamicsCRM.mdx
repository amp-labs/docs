...
<Warning>In order to receive a refresh token and be able to access your customers' Microsoft Dynamics CRM APIs without reauthenticating, you must include the `offline_access` permission when registering the app with Ampersand</Warning>
