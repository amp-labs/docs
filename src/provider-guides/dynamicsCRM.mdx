...
<Warning>In order to receive a refresh token and be able to access Microsoft Dynamics CRM API without reauthenticating, you must include the *offline_access* permission when registering the CRM app in the Microsoft Azure portal</Warning>
