...
description: "Configure a Copper CRM OAuth app and link it to Ampersand to enable read, write, and proxy actions across contacts, leads, opportunities, and more."
---
## What's Supported
