---
title: "Blackbaud"
description: "Configure a Blackbaud OAuth app in Ampersand and enable read, write, and proxy actions across CRM batches, business processes, revenue, and constituent data."
---
## What's supported
