---
title: Discourse
description: "Configure Discourse in Ampersand using an API key and API Username to send proxy calls to your customer forum instance for posts, users, and topics."
---
## What's supported
