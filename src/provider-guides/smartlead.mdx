...
The Smartlead supports the following objects:
- [Campaigns](https://api.smartlead.ai/reference/fetch-campaign-sequence-by-campaign-id) read+write
- [Email Accounts](https://api.smartlead.ai/reference/fetch-all-email-accounts-associated-to-a-user) read+write
- [Leads](https://api.smartlead.ai/reference/fetch-lead-by-email-address) read
- [Client](https://api.smartlead.ai/reference/fetch-all-clients) read+write
