...
- [Proxy Actions](/proxy-actions), using the base URL `https://platform.flatfile.com/api`.
...
## Creating an API key for Flatfile

[Click here](https://flatfile.com/docs/developer-tools/api/overview#authentication) for more information about generating an API key for Flatfile. The UI components will display this link, so that your users can successfully create API keys.
