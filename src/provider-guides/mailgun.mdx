---
title: Mailgun
description: "Set up a Mailgun integration for your application with Ampersand, covering credential configuration plus Read, Write, Subscribe, and Proxy actions."
---
## What's supported
