...
- [Subscribe Actions](/subscribe-actions) for the `messages` object. Please note that [special set up](#set-up-gmail-push-notifications) is needed for Gmail.
- [Write Actions](/write-actions).
...
<table style={{ width: '100%', minWidth: '100%', tableLayout: 'fixed', textAlign: 'center', borderCollapse: 'collapse', display: 'table' }}>
  ...
  <tbody style={{ display: 'table-row-group', width: '100%' }}>
    ...
    <tr style={{ display: 'table-row' }}><td style={{ textAlign: 'left' }}><a href="https://developers.google.com/workspace/gmail/api/reference/rest/v1/users.messages#Message">messages</a><sup>{'[2]'}</sup></td><td><Check /></td><td><Cross /></td><td><Check /><br /><a href="#set-up-gmail-push-notifications">(Setup required)</a></td></tr>
...
![Google provider app Gmail subscribe fields](/images/provider-guides/google-provider-app-gmail-subscribe-fields.png)
