...
> **Important Note on Events Backfill**: The `events` object has a 28-day limitation for historic backfill and does not support fullHistory. When syncing events data, ensure your backfill period does not exceed 28 days.
