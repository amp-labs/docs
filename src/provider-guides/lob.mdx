---
title: Lob
description: "Connect Lob to Ampersand with a Basic Auth API key, then use read, write, and proxy actions across addresses, letters, checks, campaigns, and cards."
---
## What's supported
