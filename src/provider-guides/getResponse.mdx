---
title: "GetResponse"
description: "Connect GetResponse to your product via Ampersand to read contacts, write updates, subscribe to list events, and proxy calls to the GetResponse REST API."
---
...
![Creating a GetResponse custom OAuth app](/images/provider-guides/0696f04-GetResponse.gif)
