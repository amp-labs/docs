...
![Alt text](https://files.readme.io/8f40494-pipeline1.gif)
...
![Alt text](https://files.readme.io/2799bb2-Screenshot_2024-07-08_at_21.14.56.png)
...
6. Enter the scopes set for your application in _Pipeline_. For details on the scopes, go to the [Scopes](https://www.zoho.com/people/api/scopes.html) guide in Zoho CRM documentation. 
   ...
   ![Alt text](https://files.readme.io/6e51f3b-pipeline2.gif)
