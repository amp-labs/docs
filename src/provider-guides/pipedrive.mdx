...
description: "Integrate Pipedrive CRM with your app through Ampersand. Configure Read, Write, Subscribe, and Proxy Actions to sync deals, contacts, and pipeline stages."
---
