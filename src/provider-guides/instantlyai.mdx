...
### Supported Objects
The Instantly V2 connector supports reading from the following objects:
...
The Instatnlty V2 connector supports writing from the following objects:
...
For an example manifest file of an Instantly V2 integration, visit our [samples repo on Github](https://github.com/amp-labs/samples/blob/main/instantlyai/amp.yaml).
...
To start integrating with Instantly V2:

- Create a manifest file using the [example](https://github.com/amp-labs/samples/blob/main/instantlyai/amp.yaml).
...
## Creating an API key for Instantly V2:

1. Log in to your [Instatntly Account](https://app.instantly.ai/auth/login).
...
![Alt text](/images/provider-guides/instantlyai-api-key.gif)
