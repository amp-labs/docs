...
- [Proxy Actions](/define-integrations/proxy-actions), using the base URL `https://api2.frontapp.com`.
...
- Start making [Proxy Calls](/define-integrations/proxy-actions), and Ampersand will automatically attach the API key supplied by the customer. Please note that this connector's base URL is `https://api2.frontapp.com`.
