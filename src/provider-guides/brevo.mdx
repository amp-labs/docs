---
title: Brevo
description: "Set up Brevo API credentials in Ampersand and enable read, write, and proxy actions to sync contacts, campaigns, and transactional data from the Brevo API."
---
## What's supported
