---
title: Blueshift
description: "Set up Blueshift API credentials in Ampersand and enable read, write, and proxy actions to sync customers, events, and campaigns with the Blueshift platform."
---
## What's supported
