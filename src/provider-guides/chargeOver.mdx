...
- Object names follow the ChargeOver REST API resource names, which are singular (e.g. `customer`, `invoice`). Subscriptions are addressed as `package` and contacts as `user`.
