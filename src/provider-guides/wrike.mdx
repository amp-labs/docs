...
description: "Add a Wrike integration to your product using Ampersand and run Read, Write, Subscribe, and Proxy Actions across projects, tasks, folders, and timelogs."
---
## What's Supported
...
4. Click **Register app**.
   ...
   ![Wrike App Creation](/images/provider-guides/9238305-wrike1.gif)
...
![Wrike App Creation](/images/provider-guides/07f49ca-wrike2.gif)
...
6. Enter the scopes set for your application in _Wrike_.
   ...
   ![Ampersand Integration](/images/provider-guides/982dec2-wrike3.gif)
