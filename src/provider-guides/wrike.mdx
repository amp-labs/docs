...
4. Click **Register app**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/9238305-wrike1.gif",null,"Wrike App Creation"],"align":"center"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/07f49ca-wrike2.gif",
        null,
        "Wrike App Creation"
      ],
      "align": "center"
...
6. Enter the scopes set for your application in _Wrike_.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/982dec2-wrike3.gif",null,"Ampersand Integration"],"align":"center"}]}[/block]
