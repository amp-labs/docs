---
title: "Ampersand manifest (amp.yaml) schema reference"
sidebarTitle: "Manifest schema"
description: "Complete field reference for the Ampersand manifest file (amp.yaml), covering integrations, providers, read, write, subscribe, and proxy configuration."
---
