...
description: "Reference for the Ampersand amp.yaml manifest schema, including specVersion, integration definitions, and read, write, proxy, and subscribe fields."
---
