...
2. Ensure that the checkboxes for the necessary [system permissions](/customer-guides/salesforce#required-system-permissions) are selected, and then click **Save**.
