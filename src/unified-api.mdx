...
**Merge:** Stores all customer data in Merge serves by default. "Merge Destinations" (Enterprise) enables you to turn off storage.
...
| **Raw data** | Always included | need `include_remote_data=true` flag |
