---
title: "Build your own unified API with Ampersand"
sidebarTitle: "Unified API"
description: "Design a single schema that works across multiple SaaS providers with Ampersand instead of relying on a vendor's predefined unified-API models."
---
