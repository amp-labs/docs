...
To do this, add `watchSchema` as a key in your integration defined in `amp.yaml`. You need to specify:
...
<Note>
Ampersand watches all objects in your integration for schema changes by default.
</Note>
