...
Reference documentation for Ampersand's REST APIs.

Most integration behavior is declared in your `amp.yaml` manifest rather than called directly. If you're setting up your first integration, start with [how Ampersand works](/concepts) and the [starter project](/starter-project). Come back here when you need to trigger a read on demand, write records from your backend, manage installations programmatically, or call a provider endpoint Ampersand doesn't model.
