---
title: "Access the Ampersand API with JWT authentication"
description: "Generate RSA-signed JWTs on your server and register the public key with Ampersand to securely authenticate frontend calls to the Ampersand API."
---
