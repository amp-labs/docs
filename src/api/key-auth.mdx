---
title: "Access the Ampersand API with API keys"
description: "Create, view, and use Ampersand API keys from the dashboard so your backend can authenticate requests to the Read, Write, and Platform APIs."
---
