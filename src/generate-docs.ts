      ...
      tabs: [
        {
          ...
          groups: convertNavigation(mintConfig.navigation.filter((group: any) =>
            group.group.match(/^(Get started|Actions|Data and schemas|UI library|Destinations|Notifications|Reference|Resources)$/)))
        },
        {
          tab: 'API Reference',
          groups: convertNavigation(mintConfig.navigation.filter((group: any) =>
        ...
        },
        {
          tab: 'Troubleshooting',
          groups: convertNavigation(mintConfig.navigation.filter((group: any) =>
            group.group === 'Troubleshooting guides'))
        }
      ]
    },
