...
Ampersand reads are scheduled & run on a cadence specified by you.

If you'd like the flexibility of starting the read at a specific point in time (alongside the scheduled job) you can do that with the [trigger read api](/reference/read/trigger-read).
