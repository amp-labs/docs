...
<Info>These advanced use cases are currently only supported when you creating or updating installations via the API.</Info>
          ...
          "lead": {
            ...
            "selectedFieldSettings": {
              "source": {
                  ...
                  "writeOnUpdate": "never",
                  // Write to source field on creating a record,
        ...
        "objects": {
          "lead": {
            ...
            "selectedFieldSettings": {
              "source": {
                "default": {
                  "value": "myApp" // Set the source field to myApp 
                },
              },
              "amount": {
                "default": {
                  "value": 0 // Set the amount field to 0 
                },
              },
              "source": {
                "automated": {
                  "value": true // Set the automated field to true 
                },
              },
            },
          }
          ...
          "lead": {
            ...
            "selectedFieldSettings": {
              "customSource": { // customSource is a mapped field
                  "default": {
                    "value": "myApp" // Use "mapApp" as default value
                  },
                  // Do not write to source field when updating a record.
                  "writeOnUpdate": "never",
                  // Write to source field on creating a record,
...
For this installation, the `customSource` has been mapped to the `myCustomSource` field in this particular customer's Hubspot instance, the default value for this field is "myApp" and the field will only be written to when it is a create record request, and not an update request.
