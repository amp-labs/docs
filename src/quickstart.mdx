---
title: "Ampersand quickstart: build your first integration"
description: "Follow this quickstart to build a sample Salesforce integration for a fictional app called MailMonkey using the Ampersand dashboard, CLI, and amp.yaml."
---
