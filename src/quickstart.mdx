...
> 
> <a href="https://app.getpostman.com/run-collection/45644907-32bc6952-6972-4ab4-b471-806f37ff67d3">
>   <img src="https://run.pstmn.io/button.svg#noZoom" alt="Run in Postman" />
> </a>

For this Quickstart, we are going to build integrations for a cool new app called MailMonkey - an AI-powered email campaign manager that integrates with Salesforce. You can see the final `amp.yaml` file on [Github](https://github.com/amp-labs/samples/blob/main/salesforce/amp.yaml).
