---
title: "Housecall Pro customer setup guide"
description: "Setup guide for Housecall Pro Admins to generate an API key and configure webhooks required by an Ampersand-powered integration on the MAX subscription."
---
