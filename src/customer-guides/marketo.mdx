---
title: "Marketo customer setup guide"
description: "Setup guide for Marketo admins to create an API-only role, service user, and custom service required by an Ampersand-powered Marketo integration."
---
