...
<Tabs>
  ...
  > **Note:** Salesforce no longer supports creation of new Connected Apps. If the integration you are using still relies on a Connected App, the steps below apply. For new integrations, ask the developer to migrate to an External Client App.
