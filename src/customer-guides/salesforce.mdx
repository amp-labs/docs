...
- If you want to enable quota optimization for this installation, also enable the [Quota optimization permissions](#subscribe-actions-quota-optimization-permissions)
