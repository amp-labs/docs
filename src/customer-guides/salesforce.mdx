...
## Ensure sufficient permissions for installing user
...
3. Choose the object you need (for example, **Account**) and go to **Object Access** in the left navbar. Select the **Profiles** tab at the top. Click **Edit** and grant the necessary permissions for the custom profile that you created.
...
The Salesforce Integration user license type is a special type of license that can be used for integrations and do not have UI access.
...
2. In the left-hand search bar, type **Permission Set** and open it.
...
3. Select the integration user you had created in Step A.
...
A **license** is purchases from Salesforce and determines the maximum set of permissions that can be granted to a user with that license.
