---
title: "BigQuery customer setup guide"
description: "Step-by-step guide for customers to connect a Google BigQuery dataset to an Ampersand-powered integration using a GCP service account and IAM roles."
---
