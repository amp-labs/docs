---
title: "NetSuite OAuth 2.0 client credentials setup"
description: "Guide for NetSuite administrators to configure OAuth 2.0 client credentials (M2M) and integration records for an Ampersand-powered NetSuite integration."
---
