...
| **User Email** | The email address of a Workspace user the integration should access (e.g. `user@company.com`). |
...
- The scopes requested by the integration are not a subset of the scopes authorized in step 4.
