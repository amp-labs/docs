---
title: "Google Workspace domain-wide delegation setup"
description: "Configure a Google Cloud service account with domain-wide delegation so an Ampersand integration can access Google Workspace data server to server."
---
