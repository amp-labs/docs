---
title: "Loxo customer setup guide"
description: "Setup guide for Loxo administrators to gather the domain, agency slug, and API credentials required to install an Ampersand-powered Loxo integration."
---
