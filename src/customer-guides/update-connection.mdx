---
title: "Update credentials for an Ampersand connection"
description: "Use the Manage tab in the Ampersand UI component to re-authenticate a connection when credentials expire, scopes change, or a user needs to reconnect."
---
