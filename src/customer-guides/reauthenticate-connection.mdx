If the user's connection to a provider app has expired or needs to be re-authenticated, the user can use the **Manage** tab in the `<InstallIntegration/>` component to refresh the connection. 
