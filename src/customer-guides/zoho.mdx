...
2.  Enter your **Work Email** and click **SIGN UP**. If this email is already associated with a Zoho account, you will be prompted to sign in.
3.  Enter your **Organization Name** (typically your company name). This will create your unique CRM workspace.
4.  Provide your phone number.
5.  Click **GET STARTED**.

    ![Activating ZohoCRM](/images/customer-guides/zohoCRM-signup.png)
...
#### Supported CRM Editions

The integration supports all available Zoho CRM editions: Free, Standard, Professional, Enterprise, and Ultimate.
