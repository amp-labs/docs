...
5. Scroll down to **App Authorization** section:
   - Set **Refresh Token Policy** to **Refresh token is valid until revoked**.
   - Set **IP Relaxation** to **Relax IP restrictions**.
6. Click **Save**.

<img src="/images/customer-guides/salesforce-jwt/RefreshTokenValid.png" />
...
1. In **Setup**, open **External Client App Manager** and select your External Client App.
2. Go to the **Policies** tab, click **Edit**.
4. Expand open **OAuth Policies**, under **Plugin Policies**, set **Permitted Users** to **Admin approved users are pre-authorized**. Click on **OK** in the dialog that pops up.

<img src="/images/customer-guides/salesforce-jwt/PreAuthorizeUsers.png" />

3. Expand open **App Policies**, under **Select Permission Sets**, move the permission set that you created in step 5 from **Available Permission Sets** to **Selected Permission Sets** using the arrow button (`>`).
5. Click **Save**.

<img src="/images/customer-guides/salesforce-jwt/SelectPermissionSet.png" />
