---
title: "Salesforce JWT bearer flow customer setup"
description: "Configure your Salesforce org and integration user for an Ampersand-powered integration that authenticates using the OAuth 2.0 JWT Bearer server-to-server flow."
---
