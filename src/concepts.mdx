...
You create an integration by defining it in a manifest file and then deploying it using the `amp` CLI. (See [Define Integrations](/define-integrations) and [CLI Overview](/cli/overview)).
...
- or when you make an API call to the [CreateInstallation](/reference/installation/create-a-new-installation) or [ImportInstallation](/reference/installation/import-an-existing-installation) endpoints.
