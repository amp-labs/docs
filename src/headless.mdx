---
title: "Ampersand headless UI library for React"
description: "Use Ampersand's headless React hooks to manage connections, installations, and integration config while keeping full control over your custom UI."
---
