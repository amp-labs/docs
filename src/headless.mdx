...
description: "Build custom integration UIs with @amp-labs/react headless hooks that manage connections, installations, and configuration inside AmpersandProvider."
---
