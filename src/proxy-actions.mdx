---
title: "Proxy actions: raw provider API calls via Ampersand"
description: "Use Ampersand proxy actions to make raw, authenticated HTTP requests to your customer's SaaS API without transformation or schema mapping in between."
---
