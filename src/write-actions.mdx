---
title: "Write actions: push data to customer SaaS"
description: "Define write actions in amp.yaml to create or update records in a customer's SaaS whenever your application calls the Ampersand Write API endpoint."
---
