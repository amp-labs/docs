---
title: "Configure an AWS Kinesis destination"
description: "Send records from Ampersand read and subscribe actions to an AWS Kinesis stream, including required IAM permissions, ARNs, and payload format."
---
