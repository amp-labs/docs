...
description: "Deliver Ampersand Read and Subscribe Actions to your webhook endpoint, including inline results, signed download URLs for large payloads, and retries."
---
