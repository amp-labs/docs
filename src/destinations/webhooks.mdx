...
```JavaScript JavaScript
{
    ...
    "installationId": "0c970e1c-8fbe-4b28-bf10-2beee8fbf4ce",
    ...
    "result": [
        {
            ...
            "mappedFields": {
                "accountName": "johnAmp", // `name` field mapped to `accountName` from `amp.yaml`
                "notes": "Account Description Mapped to Notes" // `description` field mapped to `notes` by user selection
            },
            "providerEventType": "UPDATE",
            "raw": {
                "AnnualRevenue": null,
                "Description": "Account Description Mapped to Notes",
                "Id": "001Dp00000ZDgmxIAD",
                "Name": "johnAmp",
                "Website": null,
                "attributes": {
