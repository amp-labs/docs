...
```
## Subscribe actions webhook results

When an event occurs in a connected SaaS instance, Ampersand triggers a Subscribe Action and sends a real-time payload to your configured webhook.
