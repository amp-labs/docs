---
title: "Configure a webhook destination"
description: "Send records from Ampersand read and subscribe actions to your HTTPS webhook endpoint, including signing, retry behavior, and payload format details."
---
