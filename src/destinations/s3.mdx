---
title: "Configure an Amazon S3 destination"
description: "Write records from Ampersand read and subscribe actions as objects to your Amazon S3 bucket, with required IAM policies, prefixes, and payload structure."
---
