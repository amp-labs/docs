---
title: "Ampersand destinations overview"
description: "Route data synced by Ampersand read and subscribe actions or notifications to webhook, Amazon S3, and AWS Kinesis destinations configured in your project."
---
