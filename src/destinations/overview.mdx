...
Ampersand currently supports webhook destinations. Destinations allow you to define where the data read from SaaS instances via a [Read Action](/read-actions) is routed to.
