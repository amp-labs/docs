---
title: "Ampersand hosted MCP server for AI agents"
description: "Connect AI agents and MCP clients to Ampersand's hosted multi-tenant MCP server to invoke 150+ SaaS connectors as native tools with a single endpoint."
---
